    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                className='border p-3 rounded-lg' id='name' type="text" placeholder='Name' maxLength='62' minLength='10' required />
                <textarea value={formData.description} onChange={handleChange} 
                className='border p-3 rounded-lg' id='description' type="text" placeholder='Description' required />
                <input value={formData.address} onChange={handleChange} 
                className='border p-3 rounded-lg' id='address' type="text" placeholder='Address' required />

                <div className='flex gap-6 flex-wrap'>
                    <div className='flex gap-2'>
                        <input onChange={handleChange} checked={formData.type === 'sale'}
                ...
                <div className='flex flex-wrap gap-6'>
                    <div className='flex items-center gap-2'>
                        ...
                        className='p-3 border border-gray-400 rounded-lg' type="number" id='bedrooms' min='1' max='10' required />
                        <p>Beds</p>
                    </div>

                    <div className='flex items-center gap-2'>
                        <input onChange={handleChange} value={formData.bathrooms} 
                        className='p-3 border border-gray-400 rounded-lg' type="number" id='bathrooms' min='1' max='10' required />
                        <p>Baths</p>
                    </div>
                    
                    <div className='flex items-center gap-2'>
                        <input onChange={handleChange} value={formData.regularPrices}
                        className='p-3 border border-gray-400 rounded-lg' type="number" id='regularPrices' min='50' max='10000000' required />
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        className='p-3 border border-gray-400 rounded-lg' type="number" id='discountedPrice' min='0' max='10000000' required />
                        <div className='flex flex-col items-center'>
